...
describe('parseXML', () => {
    ...
    it('should parse unclosed elemenmts <br>, <hr>', () => {
        const xmlString =
            '<fdmg-audio><fdmg-id>10290669</fdmg-id><fdmg-filename>audio.mp3</fdmg-filename><fdmg-original-title>Zou Qualcomm daadwerkelijk Intel overnemen?</fdmg-original-title><fdmg-title>Zou Qualcomm daadwerkelijk Intel overnemen?</fdmg-title><fdmg-duration>00:46:39</fdmg-duration><fdmg-publication-date></fdmg-publication-date></fdmg-audio><p><strong>Het ooit zo machtige Intel piept en kraakt, zien Joe van Burik en Ben van der Burg in deze nieuwe aflevering van BNR Digitaal. Na miljarden verlies en het ontslaan van tienduizenden werknemers lijkt een climax dichtbij. Óf het bedrijf wordt overgenomen, bijvoorbeeld door concurrent Qualcomm, óf er zijn vele miljarden nodig door te kunnen, bijvoorbeeld van vermogensbeheerder Apollo. &nbsp;</strong></p>\n<p>Waar gaat het heen met Intel, de laatste échte chipreus uit de Verenigde Staten, die juist zoveel gesteund werd door de Amerikaanse regering. En is dit dan ook het definitieve failliet van de verticale integratie in de chipindustrie? Het businessmodel waarbij chipfabrikanten óók hun eigen producten ontwerpen.&nbsp;</p>\n<p>De huidige én toekomstige situatie rond Intel bespreken we met twee van onze eigen chipreuzen, <strong>Jos Versteeg</strong>, analist bij InsignerGilessen en <strong>Tomas Hochstenbach</strong>, chip-expert en redacteur bij Tweakers.&nbsp;</p>\n<p><strong>Palworld in de clinch met Nintendo<hr><br></strong>Tussen al het chipsgeweld ontspint er zich in Japan een boeiend juridisch dossier. Met Nintendo in de hoofdrol, dat samen met The Pokémon Company de maker van de game Palworld aanklaagt. Dat spel kwam begint dit jaar uit en lijkt wel heel erg op Pokémon, maar dan met geweren. En: werd gauw een megahit, met 25 miljoen spelers in amper een maand tijd.&nbsp;</p>\n<p>Wat betekent deze zaak voor ons, vooral omdat het draait op patenten op elementen uit games en zo\'n ‘transmedia-franchise’? Dat vragen we aan <strong>René Otto,&nbsp;</strong>tech-jurist bij Deviant Legal en expert op dit gebied.</p>\n<p><strong>Nieuwe hardware imponeert (niet)</strong><br>September en oktober zijn traditioneel de maanden waarin belangrijke nieuwe hardware verschijnt. Dit jaar hebben we het onder meer over de iPhone 16 én de Pixel 9 Pro Fold van Google. Bij de één is de vraag of er genoeg innovatie is, bij de ander moet het grote publiek nog wennen aan de nieuwe vorm. En over nieuwe vorm gesproken: de Samsung Galaxy Ring behandelen we ook.&nbsp;</p>\n<p><strong>Meer podcasts over tech? Luister dan naar de</strong><a href="https://www.bnr.nl/podcast/cryptocast" target="_self" rel="noopener noreferrer"><strong> </strong><strong>Cryptocast</strong></a><strong>,</strong> <a href="https://www.bnr.nl/podcast/all-in-the-game" target="_self" rel="noopener noreferrer"><strong>All in the Game</strong></a><strong>,</strong> <a href="https://www.bnr.nl/podcast/de-technoloog" target="_self" rel="noopener noreferrer"><strong>De Technoloog</strong></a><strong> en de</strong><a href="https://www.bnr.nl/podcast/tech-update" target="_self" rel="noopener noreferrer"><strong> </strong><strong>Tech Update</strong></a><strong>.</strong></p>';
